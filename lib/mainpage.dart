...
class _MainPageState extends State<MainPage> {
                              ...
                              children: [
                                Container(
                                    ...
                                    child: CachedNetworkImage(
                                      imageUrl:
                                          "https://foodloverv3.000webhostapp.com/foodninjav2/images/restaurantimages/${restList[index]['restimage']}.jpg",
                                      fit: BoxFit.cover,
  ...
  void _loadRestaurant() {
    http.post(
        "https://foodloverv3.000webhostapp.com/foodninjav2/php/load_restaurant.php",
        body: {
          "location": "Changlun",
        }).then((res) {
      print(res.body);
    ...
    Navigator.push(
        ...
        MaterialPageRoute(
            builder: (BuildContext context) =>
                RestPageDetails(rest: restaurant)));
  }
}
