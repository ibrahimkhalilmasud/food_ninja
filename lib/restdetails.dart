...
class RestPageDetails extends StatefulWidget {
  final Restaurant rest;
  const RestPageDetails({Key key, this.rest}) : super(key: key);

  @override
  _RestPageDetailsState createState() => _RestPageDetailsState();
}

class _RestPageDetailsState extends State<RestPageDetails> {
      ...
      body: Column(children: [
        Container(
            ...
            child: CachedNetworkImage(
              imageUrl:
                  "https://foodloverv3.000webhostapp.com/foodninjav2/images/restaurantimages/${widget.rest.restimage}.jpg",
              fit: BoxFit.cover,
                          ...
                          child: Column(
                            children: [
                              Container(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl:
                                        "https://foodloverv3.000webhostapp.com/foodninjav2/images/foodimages/${foodList[index]['foodid']}.jpg",
                                    fit: BoxFit.cover,
  ...
  void _loadFoods() {
    http.post(
        "https://foodloverv3.000webhostapp.com/foodninjav2/php/load_foods.php",
        body: {
